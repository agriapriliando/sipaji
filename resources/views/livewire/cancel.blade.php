    ...
    <div class="bg-white border-bottom py-3 mb-2">
        <div class="container-fluid d-flex justify-content-between align-items-start align-items-md-center flex-column flex-md-row">
            ...
            <div class="d-flex justify-content-end align-items-center mt-3 mt-md-0">
                <a class="btn btn-sm btn-primary" href="{{ url('/') }}" wire:navigate><i class="ri-add-circle-line align-bottom"></i> Ajuan
                    Baru</a>
                    ...
                    <div class="card-header justify-content-between align-items-center d-md-flex">
                        ...
                        <div class="d-flex">
                            ...
                            <select wire:model.live="perPage" class="form-select" id="" style="width: 90px;">
                                ...
                                <option value="{{ $data->total() }}">{{ $data->total() }} Item</option>
                            </select>
                        ...
                        <div>
                            <div class="d-none">
                                <span class="text-muted">
                                    ...
                                    Menampilkan {{ $data->count() }} dari {{ $data->total() }} data</span>
                            </div>
                                        ...
                                        @foreach ($data as $item)
                                            <tr x-data="{ open: false }">
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank" href="{{ route('edit', ['pembatalan', $item->id]) }}" class="btn btn-warning btn-sm">
